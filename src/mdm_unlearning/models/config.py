...
from mdm_unlearning.utils.utils import find_multiple
...
class Config:
    ...
    def mlp_class(self) -> Type:
        ...
        # Import locally to avoid a circular import (arm imports config).
        from mdm_unlearning.models import arm as _arm_module

        return getattr(_arm_module, self._mlp_class)

    @property
    def norm_class(self) -> Type:
        # `self._norm_class` cannot be the type to keep the config json serializable
        if self._norm_class == "RMSNorm":
            from mdm_unlearning.models.rmsnorm import RMSNorm

            return RMSNorm
        elif self._norm_class == "FusedRMSNorm":
            from mdm_unlearning.models.rmsnorm import FusedRMSNorm
            return FusedRMSNorm
