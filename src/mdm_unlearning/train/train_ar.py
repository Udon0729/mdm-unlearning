"""
ARM (autoregressive) training script for UnTrac data attribution experiments.
Same setup as train_mdm_untrac.py but uses GPT (causal) model instead of MDM.
"""
import glob
import math
import sys
...
from mdm_unlearning.models.arm import GPT, Block, Config, CausalSelfAttention
...
# No forward_process for ARM — standard next-token prediction
...
def setup(
    ...
    hp_name = f'ar-untrac-{args.model}M-{args.max_steps}steps{exclude_tag}'
